...
\node[page] (p63) at (-1,-11) {63};
\node[page] (p113) at (0.5,-11) {113};

% Level 9
\node[page] (p85) at (-7,-12.5) {85};
...
\draw[edge] (p37) -- (p82);
\draw[edge] (p37) -- (p111);
\draw[edge] (p92) -- (fail92a);
\draw[edge] (p92) -- (fail92b);
\draw[edge] (p24) -- (p36);
