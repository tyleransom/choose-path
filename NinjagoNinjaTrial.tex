...
\node[page] (p52) at (-6.5,-10) {52};
\node[page] (p58) at (-3,-10) {58};
\node[page] (p118) at (4,-10) {118};

% Level 7
\node[page] (p20) at (-17.5,-12) {20};
\node[page] (p29) at (-15.5,-12) {29};
\node[page] (p115) at (-13.5,-12) {115};
...
\node[success] (win26) at (-9,-12) {$\checkmark$};
\node[success] (win44) at (-6,-10) {$\checkmark$};
\node[success] (win52) at (-6.5,-12) {$\checkmark$};
\node[success] (win58) at (-3,-12) {$\checkmark$};
\node[success] (win118) at (4,-12) {$\checkmark$};
\node[success] (win120) at (-11.5,-14) {$\checkmark$};

% Failure nodes (at various levels)
\node[failure] (fail20) at (-17.5,-14) {X};
\node[failure] (fail23) at (-14.5,-16) {X};
\node[failure] (fail38) at (6,-6) {X};
\node[failure] (fail46) at (-6,-6) {X};
\node[failure] (fail60a) at (-3,-10) {X};
\node[failure] (fail60b) at (-1.5,-10) {X};
\node[failure] (fail66) at (-9,-10) {X};
\node[failure] (fail68) at (-10.5,-10) {X};
\node[failure] (fail69) at (-9.5,-14) {X};
\node[failure] (fail78) at (-5.5,-8) {X};
\node[failure] (fail90) at (-17,-18) {X};
\node[failure] (fail96) at (-14,-12) {X};
\node[failure] (fail107) at (4.5,-10) {X};
\node[failure] (fail115) at (-13.5,-14) {X};
...
\draw[edge] (p73) -- (p44);
\draw[edge] (p73) -- (p52);
\draw[edge] (p60) -- (fail60a);
\draw[edge] (p60) -- (fail60b);
\draw[edge] (p61) -- (p58);
\draw[edge] (p4) -- (p119);
\draw[edge] (p4) -- (p38);
